					...
					<tr>
						<th scope="row">
							<label for="envato_username">
								<?php esc_html_e( 'Your Envato Username', 'streamtube' );?>
								<?php printf(
									'<span class="required">%s</span>',
									esc_html__( '(required)', 'streamtube' )
								);?>
						...
						<td>	
							<?php printf(
								'<input name="envato_username" type="text" id="envato_username" value="%s" class="regular-text">',
								esc_attr( StreamTube_Theme_License()->get_envato_username() )
							);?>
						</td>
					</tr>
				</tbody>
