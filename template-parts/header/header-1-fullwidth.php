...
<header id="site-header" class="site-header header-fw-1 d-flex align-items-center shadow-sm border-bottom fixed-top">
    <div class="<?php echo esc_attr( streamtube_get_container_header_classes() ); ?>">
        ...
        <div class="row align-items-center">
            <?php printf(
                '<div class="col-%s col-sm-4 col-md-4 col-lg-4 col-xl-4">',
            ...
            <?php printf(
                '<div class="col-center col-%s col-sm-4 col-md-4 col-lg-4 col-xl-4 top-0">',
                ! streamtube_is_login_page() ? '7' : '2'
            );?>
